...
const translations = {
  es: {
    ...
    skill_sistemas: "Sistemas",
    skill_redes: "Redes y Seguridad",
    skill_servicios: "Servicios",
    skill_herramientas: "Herramientas",
    skill_scripting: "Scripting",
    skill_virtual: "Virtualización, Almacenamiento y Backups",
    skill_monitorizacion: "Monitorización",
    skill_bbdd: "Bases de Datos",
  ...
  ca: {
    ...
    skill_sistemas: "Sistemes",
    skill_redes: "Xarxes i Seguretat",
    skill_servicios: "Serveis",
    skill_herramientas: "Eines",
    skill_scripting: "Scripting",
    skill_virtual: "Virtualització, Emmagatzematge i Backups",
    skill_monitorizacion: "Monitoratge",
    skill_bbdd: "Bases de Dades",
  ...
  en: {
    ...
    skill_sistemas: "Systems",
    skill_redes: "Networks & Security",
    skill_servicios: "Services",
    skill_herramientas: "Tools",
    skill_scripting: "Scripting",
    skill_virtual: "Virtualization, Storage & Backups",
    skill_monitorizacion: "Monitoring",
    skill_bbdd: "Databases",
